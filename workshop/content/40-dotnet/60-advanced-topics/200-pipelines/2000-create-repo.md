...
As usual, we first need to install the CodeCommit construct library (we already have the Lambda library installed):
...
Edit the file `CdkWorkshop/WorkshopPipelineStack.cs` as follows.
